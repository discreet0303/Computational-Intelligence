...
class Hw1Layout(tk.Tk):
    ...
    def updateCanvas(self):
        ...
        # draw sensor
        self.ax.plot([self.carCenterPos[0], self.frontLinePox[0]], [self.carCenterPos[1], self.frontLinePox[1]], linestyle='--', color='k',
                     linewidth=1, solid_capstyle='round')
        self.ax.plot([self.carCenterPos[0], self.rightLinePox[0]], [self.carCenterPos[1], self.rightLinePox[1]], linestyle='--', color='k',
                     linewidth=1, solid_capstyle='round')
        self.ax.plot([self.carCenterPos[0], self.leftLinePox[0]], [self.carCenterPos[1], self.leftLinePox[1]], linestyle='--', color='k',
                     linewidth=1, solid_capstyle='round')
        # drwa car
